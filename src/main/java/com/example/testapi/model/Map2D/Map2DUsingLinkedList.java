 ...
 * </p>
 * */
public class Map2DUsingLinkedList {
    ...
    POILinkedList[] hashTable;

    public Map2DUsingLinkedList(int size) {
        hashTable = new POILinkedList[size];
        N = size;
    }
    public Map2DUsingLinkedList() {
        hashTable = new POILinkedList[DEFAULT_SIZE];
        N = DEFAULT_SIZE;
    }

    public void put(POIListNode poi) {
        ...
        if (hashTable[hash] == null) {
            ...
            hashTable[hash] = new POILinkedList();
        }
...
//    }
//
////    public Byte removeServiceFromPOI(int x, int y, Byte serviceIndex) {
////        int hash = x;
////        Byte removed = null;
////
...
////            removed = poi.removeService(serviceIndex);
////        }
////        return removed;
////    }
////
////    public boolean addServiceToPOI(int x, int y, Byte serviceIndex) {
////        int hash = x;
////        // If there is no such POI with input x and y
////        if (hashTable[hash] == null) {
////            return false;
...
////            // Get the POI from the chain
////            POI poi = hashTable[hash].find(y);
////            return poi.addService(serviceIndex);
////        }
////    }
//
